...
typealias UsersListener = (users: List<ChatData>) -> Unit

class UsersService {

    private var users = mutableListOf<ChatData>()
    ...
    fun getUsers(): List<ChatData> {
        return users
    }

    fun deleteUser(user: ChatData) {
    ...
    fun moveUser(user: ChatData, moveBy: Int) {
