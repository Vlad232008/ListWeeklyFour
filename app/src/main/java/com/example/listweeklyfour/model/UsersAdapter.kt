...
import com.example.listweeklyfour.databinding.ItemUserBinding
...
class UsersDiffCallback(
    ...
    private val oldList: List<ChatData>,
    private val newList: List<ChatData>
...
class UsersAdapter(
    ...
    var users: List<ChatData> = emptyList()
        set(newValue) {
    ...
    override fun onBindViewHolder(holder: UsersViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            if (user.count == 0) {
                idCount.visibility = View.INVISIBLE
            }
            else idCount.text = user.count.toString()
